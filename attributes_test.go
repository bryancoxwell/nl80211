...
// 			unix.NL80211_ATTR_KEY,
// 			AttributeSetter[uint32](unix.NL80211_ATTR_KEY_TYPE, 10),
// 			AttributeSetter[uint8](unix.NL80211_ATTR_KEY_DEFAULT, 20),
// 		),
// 	)
// 	if err != nil {
// 		t.Fatal(err)
...
// 	for ad.Next() {
// 		switch ad.Type() {
// 		case unix.NL80211_ATTR_KEY:
// 			ad.Nested(func(nad *netlink.AttributeDecoder) error {
// 				for nad.Next() {
// 					switch nad.Type() {
// 					case unix.NL80211_ATTR_KEY_TYPE:
// 						val := nad.Uint32()
// 						if val != 10 {
// 							t.Fatal(fmt.Errorf("expected 10, got %d", val))
// 						}
// 					case unix.NL80211_ATTR_KEY_DEFAULT:
// 						val := nad.Uint8()
// 						if val != 20 {
