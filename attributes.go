...
type Nl80211Attribute uint16

const (
	NL80211_ATTR_UNSPEC Nl80211Attribute = iota
	NL80211_ATTR_WIPHY
...
func AttributeSetter[T AttributeType](typ Nl80211Attribute, value T) Nl80211AttributeSetter {
...
func NestedAttributeSetter(typ Nl80211Attribute, attrs ...Nl80211AttributeSetter) Nl80211AttributeSetter {
	return func(attrEncoder *netlink.AttributeEncoder) {
...
func SetAttrWiphy(wiphy uint32) Nl80211AttributeSetter {
	return AttributeSetter[uint32](NL80211_ATTR_WIPHY, wiphy)
}

func SetAttrWiphyName(name string) Nl80211AttributeSetter {
	return AttributeSetter[string](NL80211_ATTR_WIPHY_NAME, name)
}

func SetAttrIfindex(ifindex uint32) Nl80211AttributeSetter {
	return AttributeSetter[uint32](NL80211_ATTR_IFINDEX, ifindex)
}

func SetAttrIfname(ifname string) Nl80211AttributeSetter {
	return AttributeSetter[string](NL80211_ATTR_IFNAME, ifname)
}

func SetAttrIftype(iftype InterfaceType) Nl80211AttributeSetter {
	return AttributeSetter[uint32](NL80211_ATTR_IFTYPE, uint32(iftype))
}

func SetAttrMac(mac net.HardwareAddr) Nl80211AttributeSetter {
	return AttributeSetter[net.HardwareAddr](NL80211_ATTR_MAC, mac)
}

func SetAttrBeaconInterval(beaconInterval uint32) Nl80211AttributeSetter {
	return AttributeSetter[uint32](NL80211_ATTR_BEACON_INTERVAL, beaconInterval)
}

func SetAttrWiphyFreq(freq uint32) Nl80211AttributeSetter {
	return AttributeSetter[uint32](NL80211_ATTR_WIPHY_FREQ, freq)
}